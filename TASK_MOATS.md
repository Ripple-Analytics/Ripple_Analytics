# Mental Model Detection Algorithms: Moats

## Task for @Devin

Build text detection algorithms for all mental models in the **Moats** category.
...
### File Structure
```
src/mental_models/models/algorithms/moats/
...
Branch: `feature/mental-model-algorithms-moats`
