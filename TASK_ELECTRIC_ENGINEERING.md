# Electric Clojure Mental Model Algorithms: engineering

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **engineering** category.
...
```clojure
(ns mental-models.algorithms.engineering
...
## File Structure
```
src/mental_models/algorithms/engineering/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'engineering')
...
Branch: `feature/electric-algorithms-engineering`
