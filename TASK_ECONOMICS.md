# Mental Model Detection Algorithms: Economics

## Task for @Devin

Build text detection algorithms for all mental models in the **Economics** category.
...
### File Structure
```
src/mental_models/models/algorithms/economics/
...
Branch: `feature/mental-model-algorithms-economics`
