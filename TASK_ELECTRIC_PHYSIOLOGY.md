# Electric Clojure Mental Model Algorithms: physiology

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **physiology** category.
...
```clojure
(ns mental-models.algorithms.physiology
...
## File Structure
```
src/mental_models/algorithms/physiology/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'physiology')
...
Branch: `feature/electric-algorithms-physiology`
