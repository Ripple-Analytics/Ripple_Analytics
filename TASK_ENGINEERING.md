# Mental Model Detection Algorithms: Engineering

## Task for @Devin

Build text detection algorithms for all mental models in the **Engineering** category.
...
### File Structure
```
src/mental_models/models/algorithms/engineering/
...
Branch: `feature/mental-model-algorithms-engineering`
