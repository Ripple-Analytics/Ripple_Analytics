# Electric Clojure Mental Model Algorithms: thinking-tools

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **thinking-tools** category.
...
```clojure
(ns mental-models.algorithms.thinking-tools
...
## File Structure
```
src/mental_models/algorithms/thinking-tools/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'thinking-tools')
...
Branch: `feature/electric-algorithms-thinking-tools`
