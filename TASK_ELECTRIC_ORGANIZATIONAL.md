# Electric Clojure Mental Model Algorithms: organizational

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **organizational** category.
...
```clojure
(ns mental-models.algorithms.organizational
...
## File Structure
```
src/mental_models/algorithms/organizational/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'organizational')
...
Branch: `feature/electric-algorithms-organizational`
