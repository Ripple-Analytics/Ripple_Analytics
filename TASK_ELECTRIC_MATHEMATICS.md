# Electric Clojure Mental Model Algorithms: mathematics

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **mathematics** category.
...
```clojure
(ns mental-models.algorithms.mathematics
...
## File Structure
```
src/mental_models/algorithms/mathematics/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'mathematics')
...
Branch: `feature/electric-algorithms-mathematics`
