# Electric Clojure Mental Model Algorithms: accounting

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **accounting** category.
...
```clojure
(ns mental-models.algorithms.accounting
...
## File Structure
```
src/mental_models/algorithms/accounting/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'accounting')
...
Branch: `feature/electric-algorithms-accounting`
