# Mental Model Detection Algorithms: Psychology

## Task for @Devin

Build text detection algorithms for all mental models in the **Psychology** category.
...
### File Structure
```
src/mental_models/models/algorithms/psychology/
...
Branch: `feature/mental-model-algorithms-psychology`
