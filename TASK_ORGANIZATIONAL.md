# Mental Model Detection Algorithms: Organizational

## Task for @Devin

Build text detection algorithms for all mental models in the **Organizational** category.
...
### File Structure
```
src/mental_models/models/algorithms/organizational/
...
Branch: `feature/mental-model-algorithms-organizational`
