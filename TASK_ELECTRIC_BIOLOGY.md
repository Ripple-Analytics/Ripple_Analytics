# Electric Clojure Mental Model Algorithms: biology

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **biology** category.
...
```clojure
(ns mental-models.algorithms.biology
...
## File Structure
```
src/mental_models/algorithms/biology/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'biology')
...
Branch: `feature/electric-algorithms-biology`
