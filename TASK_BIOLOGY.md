# Mental Model Detection Algorithms: Biology

## Task for @Devin

Build text detection algorithms for all mental models in the **Biology** category.
...
### File Structure
```
src/mental_models/models/algorithms/biology/
...
Branch: `feature/mental-model-algorithms-biology`
