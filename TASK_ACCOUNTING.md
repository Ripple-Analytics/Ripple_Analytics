# Mental Model Detection Algorithms: Accounting

## Task for @Devin

Build text detection algorithms for all mental models in the **Accounting** category.
...
### File Structure
```
src/mental_models/models/algorithms/accounting/
...
Branch: `feature/mental-model-algorithms-accounting`
