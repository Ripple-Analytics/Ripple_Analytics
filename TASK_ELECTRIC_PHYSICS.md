# Electric Clojure Mental Model Algorithms: physics

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **physics** category.
...
```clojure
(ns mental-models.algorithms.physics
...
## File Structure
```
src/mental_models/algorithms/physics/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'physics')
...
Branch: `feature/electric-algorithms-physics`
