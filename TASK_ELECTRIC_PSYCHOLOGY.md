# Electric Clojure Mental Model Algorithms: psychology

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **psychology** category.
...
```clojure
(ns mental-models.algorithms.psychology
...
## File Structure
```
src/mental_models/algorithms/psychology/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'psychology')
...
Branch: `feature/electric-algorithms-psychology`
