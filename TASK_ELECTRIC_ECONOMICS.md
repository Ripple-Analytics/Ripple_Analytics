# Electric Clojure Mental Model Algorithms: economics

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **economics** category.
...
```clojure
(ns mental-models.algorithms.economics
...
## File Structure
```
src/mental_models/algorithms/economics/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'economics')
...
Branch: `feature/electric-algorithms-economics`
