# Mental Model Detection Algorithms: Physiology

## Task for @Devin

Build text detection algorithms for all mental models in the **Physiology** category.
...
### File Structure
```
src/mental_models/models/algorithms/physiology/
...
Branch: `feature/mental-model-algorithms-physiology`
