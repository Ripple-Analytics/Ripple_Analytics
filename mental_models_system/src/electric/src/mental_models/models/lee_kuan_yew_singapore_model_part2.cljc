(ns mental-models.models.lee-kuan-yew-singapore-model-part2
  "Mental Models - Lee Kuan Yew / Singapore Model Category (Part 2)"
  (:require [mental-models.models.core :refer [register-model failure]]))

;; ============================================
;; Category: Lee Kuan Yew / Singapore Model (Part 2)
;; ============================================
