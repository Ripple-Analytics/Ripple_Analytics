# Electric Clojure Mental Model Algorithms: chemistry

## Task for @Devin

Build **Electric Clojure** text detection algorithms for all mental models in the **chemistry** category.
...
```clojure
(ns mental-models.algorithms.chemistry
...
## File Structure
```
src/mental_models/algorithms/chemistry/
...
## Models to Implement
(See database for full list - query `mental_models` table where category = 'chemistry')
...
Branch: `feature/electric-algorithms-chemistry`
