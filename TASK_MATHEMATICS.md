# Mental Model Detection Algorithms: Mathematics

## Task for @Devin

Build text detection algorithms for all mental models in the **Mathematics** category.
...
### File Structure
```
src/mental_models/models/algorithms/mathematics/
...
Branch: `feature/mental-model-algorithms-mathematics`
