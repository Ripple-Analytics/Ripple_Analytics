# Mental Model Detection Algorithms: Physics

## Task for @Devin

Build text detection algorithms for all mental models in the **Physics** category.
...
### File Structure
```
src/mental_models/models/algorithms/physics/
...
Branch: `feature/mental-model-algorithms-physics`
