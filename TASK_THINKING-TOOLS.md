# Mental Model Detection Algorithms: Thinking-tools

## Task for @Devin

Build text detection algorithms for all mental models in the **Thinking-tools** category.
...
### File Structure
```
src/mental_models/models/algorithms/thinking-tools/
...
Branch: `feature/mental-model-algorithms-thinking-tools`
